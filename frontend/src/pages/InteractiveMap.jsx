...
const markdownComponents = {
    strong: ({node, ...props}) => <span className="font-bold text-forest-100" {...props} />,
    em: ({node, ...props}) => <span className="italic text-forest-200" {...props} />,
    ul: ({node, ...props}) => <ul className="list-disc pl-5 my-2 space-y-1 text-forest-200 marker:text-forest-500" {...props} />,
    ol: ({node, ...props}) => <ol className="list-decimal pl-5 my-2 space-y-1 text-forest-200 marker:text-forest-500" {...props} />,
    li: ({node, ...props}) => <li className="pl-1" {...props} />,
    h1: ({node, ...props}) => <h1 className="text-lg font-bold text-forest-50 mt-4 mb-2 tracking-tight" {...props} />,
    h2: ({node, ...props}) => <h2 className="text-base font-bold text-forest-100 mt-3 mb-2 tracking-tight" {...props} />,
    h3: ({node, ...props}) => <h3 className="text-sm font-bold text-forest-200 mt-2 mb-1" {...props} />,
    p: ({node, ...props}) => <p className="mb-3 last:mb-0 leading-relaxed" {...props} />,
    code: ({node, ...props}) => <code className="bg-forest-900 border border-forest-800 px-1.5 py-0.5 rounded text-forest-200 font-mono text-[11px]" {...props} />
};
                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-8">
                            {activeZone.isLoading ? (
                                ...
                                <>
                                    {/* Description */}
                                    <div className="text-sm text-forest-300 font-sans font-light tracking-wide">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="bg-forest-900/50 border border-forest-800/50 p-4 rounded-xl">
                                            <p className="text-forest-400 text-xs font-medium mb-1 uppercase tracking-wider">Recorded Count</p>
                                            <p className="text-2xl font-bold text-white">{activeZone.totalSpecies}</p>
                                        </div>
                                        <div className="bg-forest-900/50 border border-forest-800/50 p-4 rounded-xl">
                                            <p className="text-forest-400 text-xs font-medium mb-1 uppercase tracking-wider">Last Survey</p>
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-forest-900/50 border border-forest-800/50 p-4 rounded-xl text-sm text-forest-50 font-sans font-light tracking-wide shadow-inner">
                                            <ReactMarkdown components={markdownComponents}>
                                                {activeZone.dominant}
                                            </ReactMarkdown>
                                        </div>
