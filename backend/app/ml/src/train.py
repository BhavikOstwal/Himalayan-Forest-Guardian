...
for epoch in tqdm(range(40), desc="Epochs"): #for now just testing for 1 epoch
    model.train()
    total_loss = 0
...
torch.save(model.state_dict(), "../model_weights/IllegalLogging/outputs_model_new_40.pt")